			...
			<div class="row">
				<div class="col-xs-12">
					...
					<?php 
						...
						echo form_open_multipart(base_url().'admin/update_guru', $attr);
						echo form_hidden(array ('id'=> $dadmin['id_guru'], 'pw2'=> $dadmin['password'], )); ?>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="nama"> Nama Lengkap  </label>
							<div class="col-sm-9">
								<input type="text" id="nama" name="nama" placeholder="Nama Lengkap" value="<?php echo $dguru['nama']; ?>" class="col-xs-10 col-sm-6" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="uname"> Username </label>
							<div class="col-sm-9">
								<input type="text" id="uname" name="uname" placeholder="Username" value="<?php echo $dadmin['username']; ?>" class="col-xs-10 col-sm-6" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="pw1"> Password  </label>
							<div class="col-sm-9">
								<input type="text" id="pw1" name="pw1" placeholder="Kosongkan, jika tidak ingin ubah password" class="col-xs-10 col-sm-6" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="col-sm-9 col-xs-5" name="alamat" placeholder="Alamat Lengkap" rows="3"><?php echo $dguru['alamat']; ?></textarea>		
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="tipe">
									<option value="1" <?php if ($dadmin['login_type']=='1') {echo "selected";}?>>Admin</option>
									<option value="2" <?php if ($dadmin['login_type']=='2') {echo "selected";}?>>Guru</option>
									<option value="3" <?php if ($dadmin['login_type']=='3') {echo "selected";}?>>Wali</option>								
								</select>
							</div>
						</div>
