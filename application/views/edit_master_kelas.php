				...
				<div class="col-xs-12">
					...
					?>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="kelas" name="kelas" placeholder="Kelas" value="<?php echo $detail['kelas']; ?>" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" id="jurusan" name="jurusan" value="<?php echo $detail['jurusan']; ?>" placeholder="Jurusan" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="ket" name="ket" placeholder="Keterangan" value="<?php echo $detail['ket']; ?>" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select id="walas" name="walas" class="col-xs-10 col-sm-5">
									...
									?>
											<option <?php 
												if ($detail['id_guru'] == $a->id) {
													echo "selected";
												}												
											?> value="<?php echo $a->id; ?>"><?php echo $a->nama; ?></option>
